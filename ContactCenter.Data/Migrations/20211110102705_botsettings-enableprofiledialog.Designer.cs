...
namespace ContactCenter.Data.Migrations
{
    ...
    [Migration("20211110102705_botsettings-enableprofiledialog")]
    partial class botsettingsenableprofiledialog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("LastContactTransfered")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.BotSettings", b =>
                {
                    ...
                    b.Property<string>("AskNamePhrase")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("BotCallAgentsMode")
                        .HasColumnType("int");

                    b.Property<int>("BotMainDialog")
                        .HasColumnType("int");

                    b.Property<string>("ComposerDialogName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("CustomProfileSettings")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DepartmentMenuPhrase")
                        .HasColumnType("nvarchar(1024)")
                        .HasMaxLength(1024);

                    b.Property<bool>("EnableCheckIntent")
                        .HasColumnType("bit");

                    b.Property<bool>("EnableProfileDialog")
                        .HasColumnType("bit");

                    b.Property<bool>("EnableProfileDialog2")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("OutOfOfficeHoursPhrase")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TransferAgentPhrase")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.ChatChannel", b =>
                {
                    ...
                    b.Property<bool>("EnableTextToSpeech")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.DashboardContactsBySourceView", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(256)")
                        .HasMaxLength(256);
                    ...
                    b.ToTable("DashboardContactsBySourceView");
                });
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.GroupCampaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("ChangeAdmins")
                        .HasColumnType("bit");

                    b.Property<bool>("ChangeDescription")
                        .HasColumnType("bit");

                    b.Property<bool>("ChangeImage")
                        .HasColumnType("bit");

                    b.Property<bool>("ChangePermissions")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("FacePixelCode")
                        .HasColumnType("nvarchar(128)")
                        .HasMaxLength(128);

                    b.Property<int>("FirstGroupNumber")
                        .HasColumnType("int");

                    b.Property<string>("GoogleAdsCode")
                        .HasColumnType("nvarchar(256)")
                        .HasMaxLength(256);
                    ...
                    b.Property<string>("GroupAdmins")
                        .HasColumnType("nvarchar(64)")
                        .HasMaxLength(64);

                    b.Property<int?>("GroupBoardId")
                        .HasColumnType("int");

                    b.Property<int?>("GroupId")
                        .HasColumnType("int");

                    b.Property<int?>("GroupWelcomeMessageId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("LeadsListId")
                        .HasColumnType("int");

                    b.Property<int?>("LeaveMessageId")
                        .HasColumnType("int");

                    b.Property<string>("LinkSufix")
                        .HasColumnType("nvarchar(64)")
                        .HasMaxLength(64);

                    b.Property<int>("MaxClicksPerGroup")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("SendMsgChatChannelId")
                        .HasColumnType("nvarchar(32)");
                    ...
                    b.HasIndex("GroupWelcomeMessageId");

                    b.HasIndex("LeadsListId");

                    b.HasIndex("LeaveMessageId");

                    b.HasIndex("MessageId");

                    b.HasIndex("SendMsgChatChannelId");

                    b.HasIndex("WelcomeMessageId");

                    b.ToTable("GroupCampaigns");
                });

            modelBuilder.Entity("ContactCenter.Core.Models.GroupCampaignView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("GroupCampaignPageView");
                });
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.Landing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.LandingHit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.Sending", b =>
                {
                    ...
                    b.Property<int>("QtdContacts")
                        .HasColumnType("int");

                    b.Property<int>("QtdSent")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.SmartHit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.WhatsGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("CreateErrorCount")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("DescriptionSet")
                        .HasColumnType("bit");

                    b.Property<int>("GroupCampaignId")
                        .HasColumnType("int");

                    b.Property<bool>("GroupWelcomeMessageSent")
                        .HasColumnType("bit");

                    b.Property<bool>("ImageSet")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("SetImageErrorCount")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GroupCampaignId");

                    b.ToTable("WhatsGroups");
                });
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.GroupCampaign", b =>
                {
                    ...
                    b.HasOne("ContactCenter.Core.Models.Board", "GroupBoard")
                        .WithMany()
                    ...
                    b.HasOne("ContactCenter.Core.Models.Message", "GroupWelcomeMessage")
                        .WithMany()
                        .HasForeignKey("GroupWelcomeMessageId");

                    b.HasOne("ContactCenter.Core.Models.Board", "LeadsBoard")
                        .WithMany()
                        .HasForeignKey("LeadsListId");

                    b.HasOne("ContactCenter.Core.Models.Message", "LeaveMessage")
                        .WithMany()
                    ...
                    b.HasOne("ContactCenter.Core.Models.ChatChannel", "SendMsgChatChannel")
                        .WithMany()
                        .HasForeignKey("SendMsgChatChannelId");

                    b.HasOne("ContactCenter.Core.Models.Message", "WelcomeMessage")
                        .WithMany()
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.LandingHit", b =>
                {
                    ...
                    b.HasOne("ContactCenter.Core.Models.Landing", "Landing")
                        .WithMany()
            ...
            modelBuilder.Entity("ContactCenter.Core.Models.WhatsGroup", b =>
                {
                    b.HasOne("ContactCenter.Core.Models.GroupCampaign", null)
                        .WithMany("WhatsGroups")
                        .HasForeignKey("GroupCampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
