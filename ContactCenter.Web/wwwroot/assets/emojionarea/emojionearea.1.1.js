...
/*
 * Modified by Felipe Daiello - so it can be used together with custom field customization tags - chips.
 *    - will not convert HTML to text
 *    - will not copy editor content to source control
 */
...
; ( function ( factory, global ) {
    ...
    function htmlFromText(str, self) {
        /*
         * Disabled - we will save full html content
         */
        return str;
        str = str
            .replace(/&/g, '&amp;')
...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        /*
         * Count content lenght and show at message len counter
         * Added by Felipe Daiello
         */
            .on("keyup", function () {
